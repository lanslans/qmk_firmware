...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KC_NO, KC_KP_MINUS, KC_DOWN, KC_RALT, MO(1), KC_N, KC_NO, KC_NO, KC_NO, KC_NO, KC_B, KC_NO, KC_SLASH, KC_F12, KC_RIGHT, KC_LEFT,  \
  ...
  KC_NO, KC_KP_ASTERISK, KC_NUMLOCK, KC_NO, KC_DOT, KC_M, KC_C, KC_Z, KC_RCTL, KC_X, KC_V, KC_COMMA, KC_NO, KC_ENTER, KC_KP_SLASH, KC_NO,  \
  KC_NO, KC_PGUP, KC_DEL, KC_NO, KC_F8, KC_6, KC_F2, KC_GRAVE, KC_LCTRL, KC_F1, KC_5, KC_EQUAL, KC_MINUS, KC_F9, KC_INS, KC_NO), 

  [_FN1] = LAYOUT_default(
  KC_NO, KC_END, KC_NO, KC_NO, KC_9, KC_7, KC_3, KC_1, KC_F5, KC_2, KC_4, KC_8, KC_0, KC_F10, KC_NO, KC_NO,  \
  KC_NO, KC_KP_MINUS, KC_VOLD, KC_RALT, MO(1), KC_N, KC_NO, KC_NO, KC_NO, KC_NO, KC_B, KC_NO, KC_SLASH, KC_F12, KC_END, KC_HOME,  \
  ...
  KC_RSHIFT, KC_P3, KC_P1, KC_NO, KC_L, KC_J, KC_D, KC_A, KC_NO, KC_S, KC_F, KC_K, KC_SCOLON, KC_BSLASH, KC_P2, KC_KP_ENTER,  \
  KC_NO, KC_KP_ASTERISK, KC_NUMLOCK, KC_NO, KC_MEDIA_NEXT_TRACK, KC_M, KC_C, KC_Z, KC_RCTL, KC_X, KC_V, KC_MEDIA_PREV_TRACK, KC_NO, KC_ENTER, KC_KP_SLASH, KC_NO,  \
